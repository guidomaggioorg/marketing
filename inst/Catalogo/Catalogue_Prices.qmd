...
# prices_names_cla <- lapply(lafonte_iclassici(), .price_kg) # %>% setNames(IClassici)
# 
# prices_names_aro <- lapply(lafonte_gliaromatici(), .price_kg) # %>% setNames(IClassici)
# 
# prices_names_aff <- lapply(lafonte_gliaffinati(), .price_kg) # %>% setNames(IClassici)
# 
# prices_names_grare <- lapply(lafonte_ilgrande_e_i_re(), .price_kg) # %>% setNames(IClassici)
# 
# 
# prices_names_latt <- lapply(lafonte_lattesiena(), .price_kg) # %>% setNames(IClassici)
...
![Siena.](../../img/Siena-n-1-scaled.jpg)
